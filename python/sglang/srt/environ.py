...
class Envs:
    ...
    # Ascend 950 MegaMoE. A value <= 0 lets the WeLM integration derive the
    # per-EP-rank prefill capacity from the server token budget.
    ...
    SGLANG_NPU_DECODE_OPROJ_MATMUL_ALL_REDUCE = EnvBool(False)
